...
{
    [PXPrimaryGraph(typeof(ZZINSetupMaint))]
    [PXCacheName("Blog Setup")]
    [Serializable]
    public class ZZINSetup : IBqlTable
    {
        #region TagNumberingID
        [PXDBString(10, IsUnicode = true, InputMask = "")]
        [PXDefault("BLOGTAG")]
        [PXSelector(typeof(Numbering.numberingID), DescriptionField = typeof(Numbering.descr))]
        [PXUIField(DisplayName = "Tag Numbering ID")]
        public virtual string TagNumberingID { get; set; }
